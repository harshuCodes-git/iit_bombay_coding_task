        ...
        <div className="max-w-7xl mx-auto p-4">
          ...
          <div className="overflow-x-auto">
            <Table className="min-w-full bg-white rounded-xl shadow-lg overflow-hidden">
              <Thead className="bg-purple-500 text-white font-semibold text-lg">
                <Tr>
                  <Th className="py-4 px-6 text-left">Student Name</Th>
                  <Th className="py-4 px-6 text-left">Story Read</Th>
                  <Th className="py-4 px-6 text-left">Audio File</Th>
